...
This version uses MySQL ORDER BY FIELD(id,..) instruction to sort results returned by sphinx without using Ruby. It also means
...
One of the reason to create this fork is to ensure that Thinking Sphinx will behave in same way on both production and test en
